...
public class MonitoringApiRoutesConstants
{
    ...
    public const string GetTicketsEndpointRoute = "api/tehnician/tickets?pageNumber={0}&pageSize={1}";
    public const string GetTehnicianJobsEndpointRoute = "api/jobs?pageNumber={0}&pageSize={1}";
    public const string GetJobByIdEndpointRoute = "api/jobs/details?JobId={0}";
