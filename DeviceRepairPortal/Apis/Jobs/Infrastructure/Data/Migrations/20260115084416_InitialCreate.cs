        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DevicePiece = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Investigations_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvestigationIssues", x => new { x.InvestigationsId, x.IssuesId });
                    table.ForeignKey(
                        name: "FK_InvestigationIssues_Investigations_InvestigationsId",
                        column: x => x.InvestigationsId,
                        principalTable: "Investigations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvestigationIssues_Issues_IssuesId",
                        column: x => x.IssuesId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestigationIssues_IssuesId",
                table: "InvestigationIssues",
                column: "IssuesId");

            migrationBuilder.CreateIndex(
                name: "IX_Investigations_JobId",
                table: "Investigations",
                column: "JobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Issues_DevicePiece",
                table: "Issues",
                column: "DevicePiece");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketIssues_TicketsId",
                table: "TicketIssues",
                column: "TicketsId");
